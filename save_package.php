...
$packageID = ($_GET['PackageID']?$_GET['PackageID']:'');
		...
		ini_set('display_errors', 1);			
			...
			$query="UPDATE  $dbname.Package SET Label_Description='$Label_Description',
			Ingredients='$Ingredients', Common_Measure='$Common_Measure', 
			PPD_Per_Serving_Amount='$PPD_Per_Serving_Amount', PPD_Per_Serving_UofM='$PPD_Per_Serving_UofM', 
			Per_Serving_Amount='$Per_Serving_Amount', Per_Serving_Unit='$Per_Serving_Unit', 
			Source = '$Source',Collection_Date = '$Collection_Date', Comments = '$Comments', 
			Nutrition_Fact_Table='$Nutrition_Fact_Table',Nutrition_Claim='$Nutrition_Claim',
			Suggested_Direction='$Suggested_Direction',Health_Claim='$Health_Claim', Nielsen_Category='$Nielsen_Category',
			Brand='$Brand',Manufacturer='$Manufacturer',
			Country='$Country',Package_Size='$Package_Size',
			Package_Size_UofM='$Package_Size_UofM',Number_Of_Units='$Number_Of_Units',
			Storage_Type='$Storage_Type',Product_Description='$Product_Description',Storage_Statement = '$Storage_Statement',
			Per_Serving_Amount_In_Grams='$Per_Serving_Amount_In_Grams',Per_Serving_Amount_In_Grams_PPD='$Per_Serving_Amount_In_Grams_PPD'	WHERE PackageID='$packageID'";
				...
				$energy_kj_dvalue = mysqli_real_escape_string($conn,$_POST['Energy_kj_DValue']);
				
				$Saturated_Plus_Trans_Amount = mysqli_real_escape_string($conn,$_POST['Saturated_Plus_Trans_Amount']);
				$Saturated_Plus_Trans_UofM = mysqli_real_escape_string($conn,$_POST['Saturated_Plus_Trans_UofM']);
				$Saturated_Plus_Trans_DValue = mysqli_real_escape_string($conn,$_POST['Saturated_Plus_Trans_DValue']);
				
				$fat_amount = mysqli_real_escape_string($conn,$_POST['Fat_Amount']);
				$Fat_Unit_Of = mysqli_real_escape_string($conn,$_POST['Fat_Unit_Of']);
				...
				$sugar_alcohols_unit = mysqli_real_escape_string($conn,$_POST['Sugar_Alcohols_Unit']);
				$sugar_alcohols_dvalue = mysqli_real_escape_string($conn,$_POST['Sugar_Alcohols_DValue']);
...
echo "<script>setTimeout(\"location.href = 'edit_package.php?PackageID=$packageID';\",100);</script>";
