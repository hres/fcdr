...
for ($row3 = 0; $row3 < 94; $row3++) {
 ...
 fclose($handle); 
 	...
 	echo " $linked_to_market_count Label(s) Linked to existing Products via Market Share UPCs Codes \n \n";
	echo "$linked_to_label_count Label(s) Linked to existing Products via other Labels UPCs Codes \n \n";
	echo "$skipped_count Record(s) skipped \n \n";
	echo "$new_product_count Label(s) linked to new products \n \n";
	echo "$duplicate_count duplicate(s) \n \n \n \n";
	//echo "<hr style=\" border-top: 1px solid red;\">";

    $tosend = " ";
 	echo "Labels Linked to existing Products via Market Share UPCs Codes \n \n";
		...
		echo "\n Labels Linked to existing Products via other Labels UPCs Codes \n \n";
