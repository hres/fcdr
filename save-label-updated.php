...
EOQ;
		...
		echo "<script type=\"text/javascript\"> document.getElementById (\"confirm-message\"). innerHTML = \"<h3 style=\"color:Green;\"><strong>Label Successfully updated. Redirecting to the previous page...</strong></h3>\";</script>";
