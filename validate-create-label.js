...
$("#vids-search-form").validate({
 ...
 Trans_Fat_Unit : {   
    ...
    Saturated_Trans_Amount : {   
  number: true, 
         required: {
             
             depends: function(element){
          return $('#Saturated_Trans_Unit').val().length > 0;
        }}

},  
    Saturated_Trans_Unit : {   
 ...
 Fat_Amount : {   
  ...
  number: true, 
    ...
    Insolube_Fibre_Amount : {   
  number: true, 
         required: {
             
             depends: function(element){
          return $('#Insolube_Fibre_Unit').val().length > 0;
        }}
    ...
    Insolube_Fibre_Unit : {   
         ...
         required: {
             ...
             depends: function(element){
          return $('#Insolube_Fibre_Amount').val().length > 0;
        }}
  ...
  number: true, 
         required: {
             ...
             depends: function(element){
          return $('#Energy_kj_Unit_S').val().length > 0;
        }}
      ...
      Energy_kj_Unit_S : {
         ...
         required: {
             ...
             depends: function(element){
          return $('#Energy_kj_Amount_S').val().length > 0;
        }}

},
  Saturated_Trans_kj_Amount_S : {   
  number: true, 
         required: {
             
             depends: function(element){
          return $('#Saturated_Trans_kj_Unit_S').val().length > 0;
        }}

},  
    Saturated_Trans_kj_Unit_S : {   

         required: {
             
             depends: function(element){
          return $('#Saturated_Trans_kj_Amount_S').val().length > 0;
        }}
  ...
  number: true, 
    ...
    Insolube_Fibre_Unit_S : {   
         ...
         required: {
             ...
             depends: function(element){
          return $('#Insolube_Fibre_Amount_S').val().length > 0;
        }}
