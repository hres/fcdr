...
$count = $count -1;
  echo "$count Records on the spreadsheet";



  echo "$skipped_market_share Market Share Skipped Because of Missing Mandatory Fields \n";
  ...
  echo "\n \n $new_product_count New Product(s) created\n";
  ...
  echo "\n \n $market_share_linked Market Share Linked to Existing Product \n";
		...
		echo "\n \n $duplicate_count Duplicate(s) Market Share\n";
